...
namespace M3_RRO_JSC
{
    ...
    /// <summary>
    /// J’utilise une enum pour éviter les valeurs invalides. 
    /// L’utilisateur choisit un sens dans la liste, puis je le convertis en booléen pour respecter le type BOOLEAN de la base de données.
    /// </summary>
